            ...
            <div class="col-lg-3">
                <nav class="sidebar-nav">
                    <ul class="nav nav-pills nav-stacked">
                        ...
                        <li class="active"><a href="productBySupp.php">Product by Supplier</a></li>
                        <?php
                        if(isset($_COOKIE['userid']))
                        {
                            ?>
					...
					else
					{
                        ...
                        if(isset($_POST['submit']))
                        {
                            if(!empty($_POST['supplier']))
                            {
                                ...
                                require("connect.php");
                                $sql = "SELECT p.id, p.name, p.description, p.cost_price, p.size, s.name AS 'supplier', s.phone AS 'phone', s.email AS 'email', c.name AS 'category'
                                        FROM product p
                                ...
                                if ($result->num_rows > 0) {
                                    ...
                                    echo "<h2>$supplier</h2>";
                                    echo "<p>Phone: $s_phone</p>";
                                    echo "<p>Email: $s_email</p>";
                                    ...
                                    echo "There are currently no products for that supplier";
                                }
                                $conn->close();
                            } else {
